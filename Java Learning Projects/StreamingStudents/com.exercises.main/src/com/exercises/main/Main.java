...
//                .forEach(System.out::println);
        ...
        Arrays.stream(students)
                ...
                .toList()
                .forEach(System.out::println);
        //toList and forEach are terminal operation, but we can use only one terminal operation
        //how this can be valid? Because forEach is not terminal operation, it is List method.
